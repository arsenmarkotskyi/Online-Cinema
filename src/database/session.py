...
async def init_db() -> None:
    ...
    It should be called at application startup so the database schema exists.
    """
...
async def close_db() -> None:
    ...
    This function disposes of the database engine, releasing all associated
    resources. Call it on shutdown to close the connection pool.
    """
